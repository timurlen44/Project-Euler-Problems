...
/*
  int sayi_char_array[1000] =
{ 6,4,0,7,7,1,7,6,5,3,1,3,3,0,6,2,4,9,1,9,2,2,5,1,1,9,6,7,4,4,2,6,5,7,4,7,4,2,3,5,5,3,4,9,1,9,4,9,3,4,9,6,9,8,3,5,2,0,3,
...
signed long long int convert_fonksiyonum(){
	...
	unsigned long long int gecici_sayi2=1;
