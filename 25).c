#include<stdio.h>
unsigned long long int toplam = 0,ilk_terim=1,ikinci_terim=1,gecici_terim=1;
int main()
{
	/*
for(int i=3;i<=1000;i++){
	gecici_terim=ikinci_terim;
	ikinci_terim=ikinci_terim+ilk_terim;
	ilk_terim=gecici_terim;
	printf("ilk_terim=%llu,ikinci_terim=%llu\n",ilk_terim,ikinci_terim);
}*/
